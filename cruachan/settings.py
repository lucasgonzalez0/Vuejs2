"""
Django settings for cruachan project.
...
SECRET_KEY = 'hm$!p*_-uof5im&9r+0=y9(b23b#b(clkfbjx1$w(%se4$dxis'
...
WSGI_APPLICATION = 'cruachan.wsgi.application'
